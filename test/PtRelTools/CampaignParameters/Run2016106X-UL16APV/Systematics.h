...
TString FitSystematicName[nFitSystematics] = {"_Central", "_PileUpDown", "_PileUpUp", "_GluonSplittingBDown", "_GluonSplittingBUp", "_MuPt6", "_MuPt8", "_MuDRMinus", "_MuDRPlus", "_JEUDataDown", "_JEUDataUp", "_JBPL", "_JBPT", "_BTemplatesMinus", "_BTemplatesPlus", "_Central_LightCharmRatio-m30", "_Central_LightCharmRatio-p30", "_Central_bCorr", "_Central_bCorr", "_Central_cJetsDown", "_Central_cJetsUp"}; 

const int nScaleFactorSystematics = 11;
TString ScaleFactorSystematicName[nScaleFactorSystematics] = {"_Statistics", "_PileUp", "_GluonSplitting", "_MuPt", "_MuDR", "_JEUData", "_AwayTagger", "_BFragmentation", "_LightToCharmRatio", "_bCorr", "_cJets"};
TString ScaleFactorSystematicStoredName[nScaleFactorSystematics] = {"statistic", "pileup", "gluonsplitting", "mupt", "mudr", "jes", "jetaway", "bfragmentation", "l2c", "btempcorr", "cjets"};
